...
function Navbar({ userInfo }){
    ...
    const openProfileCard = () => {
        const profilecard = document.querySelector('nav .inner .right .buttons .profile .profilecard');
                ...
                <div className="inner">
                    ...
                    <div className="center">
                        ...
                        <div className="micbox">
                            ...
                            <label>Search with your voice</label>
                        </div>
                    </div>
                    <div className="right">
                                                ...
                                                <div className="name">
                                                    <div className="left">
                                                        <div className="authorimg">
                                                            <img src={userInfo.channelimage ? userInfo.channelimage : logo} />
                                                        </div>
                                                    </div>
                                                    <div className="right">
                                                        <h3>{userInfo.channeluser ? userInfo.channeluser : "Loading..."}</h3>
                                                ...
                                                <div className="options">
                                                    <div className="option">
                                                        <ul>
                                                            <li>
                                                                <button>
                                                                    <NavLink to={`/@${userInfo.channelslug}`}>
                                                                        <svg viewBox="0 0 24 24" preserveAspectRatio="xMidYMid meet" focusable="false" className="style-scope yt-icon"><g className="style-scope yt-icon"><path d="M3,3v18h18V3H3z M4.99,20c0.39-2.62,2.38-5.1,7.01-5.1s6.62,2.48,7.01,5.1H4.99z M9,10c0-1.65,1.35-3,3-3s3,1.35,3,3 c0,1.65-1.35,3-3,3S9,11.65,9,10z M12.72,13.93C14.58,13.59,16,11.96,16,10c0-2.21-1.79-4-4-4c-2.21,0-4,1.79-4,4 c0,1.96,1.42,3.59,3.28,3.93c-4.42,0.25-6.84,2.8-7.28,6V4h16v15.93C19.56,16.73,17.14,14.18,12.72,13.93z" className="style-scope yt-icon"></path></g></svg>
                                                            ...
                                                            <li>
                                                                <button>
                                                                    <a href="#">
                                                                        <svg enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="M20 3v18H8v-1h11V4H8V3h12zm-8.9 12.1.7.7 4.4-4.4L11.8 7l-.7.7 3.1 3.1H3v1h11.3l-3.2 3.3z"></path></svg>
                                                            ...
                                                            <li>
                                                                <button>
                                                                    <a href="#">
                                                                        ...
                                                                        <label>Purchases and memberships</label>
                                                                    </a>
                                                                </button>
                                                            </li>
                                                            <li>
                                                    ...
                                                    <div className="option">
                                                        <ul>
                                                            <li>
                                                                <button id="themebtn">
                                                                    <a href="#">
                                                                        ...
                                                                        <label>Appearance: Light Theme</label>
                                                                    </a>
                                                                </button>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <button>
                                                                    <a href="#">
                                                                        ...
                                                                        <label>Restricted Mode: off</label>
                                                                    </a>
                                                                </button>
                                                            </li>
                                                            <li>
                                                            ...
                                                            <li>
                                                                <button>
                                                                    <a href="#">
                                                                        <svg height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="M16 16H8v-2h8v2zm0-5h-2v2h2v-2zm3 0h-2v2h2v-2zm-6 0h-2v2h2v-2zm-3 0H8v2h2v-2zm-3 0H5v2h2v-2zm9-3h-2v2h2V8zm3 0h-2v2h2V8zm-6 0h-2v2h2V8zm-3 0H8v2h2V8zM7 8H5v2h2V8zm15-3v14H2V5h20zm-1 1H3v12h18V6z"></path></svg>
                                                    ...
                                                    <div className="option">
                                                        <ul>
                                                            ...
                                                            <li>
                                                                <button>
                                                                    <a href="#">
                                                                        <svg enableBackground="new 0 0 24 24" height="24" viewBox="0 0 24 24" width="24" focusable="false"><path d="M13 14h-2v-2h2v2zm0-9h-2v6h2V5zm6-2H5v16.59l3.29-3.29.3-.3H19V3m1-1v15H9l-5 5V2h16z"></path></svg>
