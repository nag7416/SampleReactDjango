...
function LikedVideosDetail({ userInfo }) {
...
//         try {
//             const response = await axiosInstance.put(`http://localhost:8000/api/${videoId}/toggle_like`);
...
//         try {
//             const response = await axiosInstance.put(`http://localhost:8000/api/${video.channelsl}/toggle_subscribe`);
//             const data = response.data;
...
//         const cleanurl = `http://localhost:8000/api/get_video/${videoid}`

//         axiosInstance.get(cleanurl)
//         .then(response => {
//             setIsLoading(false);
...
//                 const response = await fetch(`http://localhost:8000/api/${videoId}/post_comment`, {
//                     method: 'POST',
//                     headers: {
...
//     const loadComments = () => {
//         const cleanurlcomment = `http://localhost:8000/api/${videoId}/comments`;
//         fetch(cleanurlcomment, {
//             method: 'GET',
//             credentials: 'include',
//         })
//         .then(response => {
...
//         <>
//             <Helmet>
//             <title>{video.title ? `${video.title} Video Detail - YouTube` : 'YouTube'}</title>
//             </Helmet>
...
//                                                             <input name='comment_body' type="text" placeholder="Add a comment" onFocus={openPostingCon} onInput={enableDisableBtn} value={commentText} onChange={(e) => setCommentText(e.target.value)} disabled={isSubmitting} autoFocus ref={commentInputRef} />
//                                                             <span></span>
...
export default LikedVideosDetail;